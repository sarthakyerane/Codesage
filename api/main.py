...
app = FastAPI(
    title="CodeSage",
    description="""
## 🧠 CodeSage: C++ DSA RAG Agent

Upload your C++ DSA solutions and ask AI to:
- **Debug** memory leaks, segfaults, wrong outputs
- **Generate** unit tests automatically
- **Explain** algorithm complexity and flow

### Quick Start
1. `POST /upload_code` — Upload a `.cpp` file
